				...
				<div class="container">
					...
					<div class="nav-collapse navbar-responsive-collapse in collapse"
						...
						<ul class="nav">
							...
							<li class="navElement"><a class="smoothLink" href="contact.php">Contact</a>
							</li>
							<?php 
                		if(isset($_SESSION['authenticated']) && $_SESSION['authenticated'] == true){?><li class="navElement"><a class="smoothLink" href="cart.php" ><i class="icon-shopping-cart icon-white"></i><span class="badge badge-info">8</span></a></li><?php }?>
						</ul>
					</div>
